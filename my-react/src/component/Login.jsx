    ...
    logIn() {
        ...
        .then((response)=> {
            if(response.data.statusCode === 200)    {
               ...
               // code to wait token to get expired and new token to work
               ...
               // code to hit RefreshToken API code

                this.serv.RefreshToken(student1)
                   .then((response)=> {
                     if(response.data.statusCode === 200) {
                        sessionStorage.setItem('refresh-token', response.data.data);
                        alert("Refresh Token set")
                   }else{
